...
**Time**: ~3–4 hours · **Prerequisites**: Module 05 (Skills & Commands), Lab 05
...
**Time**: ~2–3 hours · **Prerequisites**: Module 05 (Skills & Commands), Lab 05
...
**Time**: ~5–7 hours · **Prerequisites**: Modules 06–07 (MCP), Lab 06 · Requires: GitHub or Linear MCP server configured
...
|---------|-----------|-----------------|
| 1.1 Author Skills | Skill YAML authoring, trigger design, output formatting | M05 Skills & Commands |
| 1.2 Slash Command | Command orchestration, multi-step sequencing | M05 Skills & Commands |
...
| 2.2 Issue-to-PR | MCP (Linear/GitHub), issue tracking, PR workflow | M06/07 MCP |
| 2.3 PR Review Agent | Structured review, subagent scope, comparative evaluation | M09 Multi-Agent |
| 3.1 Productivity Toolkit | Skills + commands + subagents as a system | M05, M08 |
| 3.1B Bridge Mission | Partial pipeline + enforced checkpoint + handoff artifacts | M05, M08, M12 |
